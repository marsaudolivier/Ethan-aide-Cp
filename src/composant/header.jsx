...
<header className="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
  ...
  <ul className="nav nav-pills">
          ...
          <li className="nav-item"><a href="/lettreLxXl" className={`nav-link ${isActive('/lettreLxXl')}`}>Lettre LxXl</a></li>
          <li className="nav-item"><a href="/lettreMxXm" className={`nav-link ${isActive('/lettreMxXm')}`}>Lettre MxXm</a></li>
